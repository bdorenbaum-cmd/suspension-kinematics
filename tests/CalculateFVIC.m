classdef CalculateFVIC < matlab.unittest.TestCase
    ...
    methods (Test)
         function verify_at_ride_height(testCase)
            result = calculate_fvic(testCase.P, testCase.UO_AT_0, testCase.LO_AT_0, testCase.WC_AT_0);
        ...
        function verify_in_bump(testCase)
            result = calculate_fvic(testCase.P, testCase.UO_IN_BUMP, testCase.LO_IN_BUMP, testCase.WC_IN_BUMP);
        ...
        function verify_in_droop(testCase)
            result = calculate_fvic(testCase.P, testCase.UO_IN_DROOP, testCase.LO_IN_DROOP, testCase.WC_IN_DROOP);
