classdef CalculateInstantAxis < matlab.unittest.TestCase
    ...
    methods (Test)
        function verify_at_ride_height(testCase)
            [point_result, axis_result] = calculate_instant_axis(testCase.P, testCase.UO_AT_0, testCase.LO_AT_0);
        ...
        function verify_in_bump(testCase)
            [point_result, axis_result] = calculate_instant_axis(testCase.P, testCase.UO_IN_BUMP, testCase.LO_IN_BUMP);
        ...
        function verify_in_droop(testCase)
            [point_result, axis_result] = calculate_instant_axis(testCase.P, testCase.UO_IN_DROOP, testCase.LO_IN_DROOP);
